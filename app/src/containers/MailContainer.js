    ...
    for (let i = 0; i < 3; i++) {
      ...
      if (group.id % 3 === i) {
        ...
        content =
          ...
          Location: ${preparingTheMeal.postalAddress},  ${preparingTheMeal.addressAddition}
        ...
        <Grid container spacing={24} justify="center">
          {groups.map(group => {
            ...
            return (
              ...
              >
                <a
                  href={`mailto:${group.mailAddress}?subject=Running Dinner&body=${mailContent}`}
                >
                  {group.name}
                </a>
              </Grid>
